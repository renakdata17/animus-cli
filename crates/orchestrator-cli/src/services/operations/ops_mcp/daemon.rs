use super::{
    push_bool_flag, push_bool_set, push_opt, push_opt_num, push_opt_usize, DaemonConfigSetInput,
    DaemonEventsInput, DaemonLogsInput, DaemonStartInput, DEFAULT_DAEMON_EVENTS_LIMIT,
...
pub(super) fn build_daemon_events_poll_result(
    default_project_root: &str,
...
pub(super) fn build_daemon_logs_result(
    default_project_root: &str,
    input: DaemonLogsInput,
) -> Result<Value> {
    let project_root = resolve_daemon_events_project_root(default_project_root, input.project_root);
